 ...
 * @ingroup capi
 * @brief C API for ISO/IEC 9797-1 Padding Method 1 (M1) padder in padpp.
 *
 * This header defines a C interface for the ISO9797 Method 1 padder.
...
#define PADPPC_ISO9797_M1_BYTE_PADDER_C_H
...
_PADPP_EXTERN_C _PADPP_CXX_only({)
  ...
  /**
  * @brief Creates a new ISO9797 M1 padder instance.
  * @return A handle to the padder, or NULL on failure.
  */
  _PADPP_PUBLIC padpp_handle_t padpp_create_iso9797_m1(void);

  /**
   * @brief Destroys an ISO9797 M1 padder instance.
   * @param ctx The padder handle to destroy.
   */
  _PADPP_PUBLIC void padpp_destroy_iso9797_m1(padpp_handle_t ctx);

  /**
   * @brief Applies ISO9797 Method 1 padding to the input data.
   *
   ...
   */
  _PADPP_PUBLIC int padpp_pad_iso9797_m1(padpp_handle_t ctx, uint8_t* dst,
                                         size_t* dst_len, const uint8_t* src,
                                         size_t src_len, size_t block_size);

  /**
   * @brief Placeholder for unpadding function for ISO9797 M1.
   *
   * ISO9797 Method 1 is not designed to be reversible in the general case.
   *
   * @param ctx         Padder context.
   ...
   */
  _PADPP_PUBLIC int padpp_unpad_iso9797_m1(padpp_handle_t ctx, uint8_t* dst,
                                           size_t* dst_len, const uint8_t* src,
                                           size_t src_len, size_t block_size);
...
#endif // PADPPC_ISO9797_M1_BYTE_PADDER_C_H
