...
main(void)
{
  padpp_handle_t padder = padpp_create_iso9797_m1();
  if (!padder)
  {
  ...
  int pad_result = padpp_pad_iso9797_m1(padder, padded, &padded_len,
  ...
  if (pad_result != 0)
  {
    ...
    padpp_destroy_iso9797_m1(padder);
    return 1;
  }
  ...
  int unpad_result = padpp_unpad_iso9797_m1(padder, unpadded, &unpadded_len,
